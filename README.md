...
![Loss function](https://latex.codecogs.com/svg.latex?\mathcal{L}=\alpha\cdot\mathcal{L}_{\text{Huber}}+\beta\cdot\mathcal{L}_{\text{Gradient}}+\gamma\cdot\mathcal{L}_{\text{TV}})
